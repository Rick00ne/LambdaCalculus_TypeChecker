...
var $author$project$Main$SetDisplayRules = function (a) {
	return {$: 'SetDisplayRules', a: a};
};
var $author$project$Main$SetShortContext = function (a) {
	return {$: 'SetShortContext', a: a};
};
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$id('report_button')
									]),
								_List_Nil)
							])),
						A2(
				...
				_List_fromArray(
					[
						...
						_Utils_ap(
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('zoom')
								]),
							dui ? _List_fromArray(
								[
									...
									[
										...
										_List_fromArray(
											[
												...
												$elm$html$Html$Attributes$id('zoom_minus')
											]),
										_List_fromArray(
											[
												$elm$html$Html$text('-')
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$disabled(dui),
												$elm$html$Html$Attributes$id('zoom_plus')
											]),
										_List_fromArray(
											[
												$elm$html$Html$text('+')
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										model.showTreeUI ? A4(
										$author$project$Main$showTree,
										model.tree,
										model.vars,
										model.displayRules,
										model.shortContext ? $elm$core$Maybe$Just(
											_Utils_Tuple2(_List_Nil, 0)) : $elm$core$Maybe$Nothing) : A2($elm$html$Html$div, _List_Nil, _List_Nil)
									]))
							])),
						A2(
						$elm$html$Html$div,
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('short context'),
												A2(
												$elm$html$Html$input,
												_List_fromArray(
													[
														$elm$html$Html$Events$onCheck($author$project$Main$SetShortContext),
														$elm$html$Html$Attributes$disabled(dui),
														$elm$html$Html$Attributes$type_('checkbox'),
														$elm$html$Html$Attributes$checked(model.shortContext)
													]),
												_List_Nil)
											])),
										A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$text('show rules'),
												A2(
												$elm$html$Html$input,
												_List_fromArray(
													[
														$elm$html$Html$Events$onCheck($author$project$Main$SetDisplayRules),
														$elm$html$Html$Attributes$disabled(dui),
														$elm$html$Html$Attributes$type_('checkbox'),
														$elm$html$Html$Attributes$checked(model.displayRules)
													]),
												_List_Nil)
											]))
									]))
