...
var $author$project$Main$Ann = F2(
	function (a, b) {
		return {$: 'Ann', a: a, b: b};
	});
var $author$project$Main$Bool = function (a) {
	return {$: 'Bool', a: a};
};
var $author$project$Main$Node = function (a) {
	return {$: 'Node', a: a};
};
var $author$project$Main$TFree = function (a) {
	return {$: 'TFree', a: a};
};
			...
			tree: $author$project$Main$Tree(
				{
					...
					parent: _Utils_Tuple2(
						...
						A2(
							...
							$author$project$Main$Bool(false),
...
var $author$project$Main$makeAssumptions = function (_v0) {
	var c = _v0.a;
	var t = _v0.b;
	if (t.$ === 'Ann') {
		var term = t.a;
		...
		switch (term.$) {
			...
			case 'Int':
				return _Utils_eq(
					ty,
					$author$project$Main$TFree('Int')) ? _Utils_Tuple2($author$project$Main$Leaf, _List_Nil) : _Utils_Tuple2(
			...
			case 'Bool':
				return _Utils_eq(
					ty,
					$author$project$Main$TFree('Bool')) ? _Utils_Tuple2($author$project$Main$Leaf, _List_Nil) : _Utils_Tuple2(
					$author$project$Main$TypeErr(
						...
						_List_fromArray(
							[
								...
								$author$project$Main$Tree(
								{
									...
									parent: _Utils_Tuple2(
										c,
										A2($author$project$Main$Ann, b1, ty))
								}),
								$author$project$Main$Tree(
								{
									children: $author$project$Main$Node(_List_Nil),
									parent: _Utils_Tuple2(
										c,
										A2($author$project$Main$Ann, b2, ty))
								})
							])),
					_List_Nil);
			case 'Lam':
											...
											_Utils_ap(
												...
												_List_fromArray(
													[
														_Utils_Tuple2(
														n,
														$author$project$Main$HasType(varTy))
													])),
											A2($author$project$Main$Ann, t1, ty2))
									})
								])),
						subs) : _Utils_Tuple2(
...
var $author$project$Main$typeSub = F2(
	function (_v0, subs) {
		var t = _v0.a;
		var _v1 = t.parent.b;
		if (_v1.$ === 'Ann') {
				...
				switch (ty0.$) {
					case 'TInf':
						...
						return A2(
							...
							ty0,
							A2($author$project$Main$lookUp, n, subs));
					case 'Fun':
						var ty1 = ty0.a;
						var ty2 = ty0.b;
						return A2(
		...
		switch (assums.$) {
			...
			case 'Node':
				...
				var gradualEx = A3(
					$elm$core$List$foldl,
					F2(
						function (child, accum) {
							var _v4 = $elm$core$List$reverse(accum);
							if (!_v4.b) {
								return _List_fromArray(
									[
								...
								var c = _v4.a;
								var _v5 = $elm$core$List$reverse(c);
								if (!_v5.b) {
									return _List_fromArray(
										[
											A2($author$project$Main$expandStepped, child, allTypeVars)
					...
					_List_Nil,
					list);
				var chLastStepTrees = A2(
					$elm$core$List$map,
					function (steps) {
						var _v3 = $elm$core$List$reverse(steps);
						if (!_v3.b) {
							return $author$project$Main$Tree(
								{
							...
							return A2(
								...
								function (step) {
									var newChildren = _Utils_ap(
										A2($elm$core$List$take, i, chLastStepTrees),
										_Utils_ap(
											_List_fromArray(
												[step.tree]),
									...
									return _Utils_update(
										step,
										{
											tree: $author$project$Main$Tree(
												{
													children: $author$project$Main$Node(newChildren),
													parent: tree.parent
												})
										});
								},
				...
				var baseStep = {
					...
					tree: $author$project$Main$Tree(
						{
							children: $author$project$Main$Node(list),
							parent: tree.parent
						})
				};
				return A2($elm$core$List$cons, baseStep, laterSteps);
			default:
				var someLeaf = assums;
				return _List_fromArray(
					[
						...
						subs: allTypeVars,
						tree: $author$project$Main$Tree(
							{children: someLeaf, parent: tree.parent})
					}
					]);
		}
	});
...
var $author$project$Main$contextItemP = A2(
	...
	A2(
		...
		A2(
			...
			A2(
				$elm$parser$Parser$ignorer,
				A2($elm$parser$Parser$ignorer, $author$project$Main$varP, $elm$parser$Parser$spaces),
				$elm$parser$Parser$symbol(':')),
			$elm$parser$Parser$spaces)),
	$author$project$Main$typeP);
...
var $author$project$Main$contextP = $elm$parser$Parser$sequence(
	{end: '', item: $author$project$Main$contextItemP, separator: ',', spaces: $elm$parser$Parser$spaces, start: '', trailing: $elm$parser$Parser$Optional});
...
var $author$project$Main$AppPT = F2(
	function (a, b) {
		return {$: 'AppPT', a: a, b: b};
	});
var $author$project$Main$BoolPT = function (a) {
	return {$: 'BoolPT', a: a};
};
...
var $author$project$Main$condTerm = function (config) {
	return A2(
		...
		A2(
			...
			A2(
				$elm$parser$Parser$keeper,
				$elm$parser$Parser$succeed($author$project$Main$CondPT),
				A4(
		...
		A2(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$parser$Parser$ignorer,
						$elm$parser$Parser$succeed($author$project$Main$LamPT),
			...
			A2(
				...
				$elm$parser$Parser$symbol('.'))),
		A2($dmy$elm_pratt_parser$Pratt$subExpression, 4, config));
};
...
var $author$project$Main$termP = $dmy$elm_pratt_parser$Pratt$expression(
	{
		...
		oneOf: _List_fromArray(
			[
				...
				$author$project$Main$BoolPT(true)),
				A2(
				$dmy$elm_pratt_parser$Pratt$constant,
...
var $author$project$Main$noncontextProgramP = A2(
	...
	A2(
		...
		$elm$parser$Parser$succeed(
			F2(
				function (te, ty) {
					return _Utils_Tuple3(_List_Nil, te, ty);
				})),
		A2(
			$elm$parser$Parser$ignorer,
			A2(
	...
	function (index, pc) {
		if (!pc.b) {
			...
			return A2(
				...
				_Utils_Tuple2(
					index,
					$author$project$Main$HasType(ty)),
				A2($author$project$Main$transformContext, index + 1, rest));
		}
	});
var $author$project$Main$App = F3(
	function (a, b, c) {
		return {$: 'App', a: a, b: b, c: c};
	});
	...
	function (pt, allVars, scopeVars, nextVarIndex, nextAppIndex) {
		...
		switch (pt.$) {
				...
				if (found.b) {
					...
					return $elm$core$Result$Ok(
						_Utils_Tuple3(
							...
							_Utils_Tuple3(
								scopeVars,
								$author$project$Main$Var(f),
								allVars)));
				} else {
					return $elm$core$Result$Err('unknown variable \'' + (str + '\''));
				}
			case 'LamPT':
				var str = pt.a;
				var ty = pt.b;
				...
				var newSv = _Utils_ap(
					...
					_List_fromArray(
						[
							_Utils_Tuple2(nextVarIndex, str)
						]));
				var newAv = _Utils_ap(
					allVars,
					_List_fromArray(
						[str]));
				var r = A5($author$project$Main$transformTIter, term, newAv, newSv, nextVarIndex + 1, nextAppIndex);
				var found = A2(find, str, scopeVars);
				if (found.b) {
					var f = found.a;
					var rest = found.b;
					...
					if (r.$ === 'Ok') {
						...
						return $elm$core$Result$Ok(
							_Utils_Tuple3(
								...
								_Utils_Tuple3(
									sv,
									A3($author$project$Main$Lam, nextVarIndex, ty, t),
									av)));
					} else {
						var err = r;
						return err;
			...
			case 'CondPT':
				...
				var term2 = pt.b;
				var term3 = pt.c;
				var r1 = A5($author$project$Main$transformTIter, term1, allVars, scopeVars, nextVarIndex, nextAppIndex);
				var r2 = A2(andThenIter, r1, term2);
...
var $author$project$Main$selectStep = F2(
	function (i, list) {
		return (i <= 1) ? $elm$core$List$head(list) : A2(
			$elm$core$Maybe$andThen,
			$author$project$Main$selectStep(i - 1),
	...
	function (msg, model) {
		...
		var getStep = function (n) {
			return A2(
				$elm$core$Maybe$withDefault,
				defStep,
				A2($author$project$Main$selectStep, n, model.steps));
		};
		switch (msg.$) {
			case 'Reset':
				var step = getStep(1);
			...
			case 'ChangeInput':
				...
				var myReplace = F2(
					function (_v1, str) {
						var keyword = _v1.a;
						var value = _v1.b;
						return A3($elm$core$String$replace, keyword, value, str);
					});
				var processedInput = A3($elm$core$List$foldl, myReplace, newInput, replacements);
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			default:
				...
				if (processedInput.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{iNote: str, showTreeUI: false, tNote: ''}),
						$elm$core$Platform$Cmd$none);
				}
		}
	});
...
var $author$project$Main$showContext = F2(
	function (c, v) {
		var toStr = function (n) {
			var _v3 = A2($author$project$Main$atIndex, n, v);
			if (_v3.$ === 'Just') {
				var str = _v3.a;
				return str;
			} else {
		...
		if (!c.b) {
			...
			if (!c.b.b) {
				...
				var t = _v2.b.a;
				var l = c.b;
				return toStr(n) + (':' + ($author$project$Main$showType(t) + (', ' + A2($author$project$Main$showContext, l, v))));
			}
		}
	});
	...
	function (t, v) {
		switch (t.$) {
			...
			case 'App':
				var t1 = t.b;
				var t2 = t.c;
				return '(' + (A2($author$project$Main$showTerm, t1, v) + (' ' + (A2($author$project$Main$showTerm, t2, v) + ')')));
			case 'Cond':
				var c = t.a;
				var t1 = t.b;
				var t2 = t.c;
			...
			default:
				var b = t.a;
				return $elm$core$Debug$toString(b);
		}
	});
...
var $author$project$Main$showTree = F2(
	function (_v0, vars) {
		var t = _v0.a;
		var ws = function () {
			var _v4 = $hecrj$html_parser$Html$Parser$Util$toVirtualDom(
				A2(
					$elm$core$Result$withDefault,
					_List_Nil,
		...
		while (true) {
			switch (_v1.$) {
				case 'Node':
					if (!_v1.a.b) {
						return $elm$html$Html$text(
							A2($author$project$Main$showContext, t.parent.a, vars) + (' ⊢ ' + A2($author$project$Main$showTerm, t.parent.b, vars)));
					} else {
						break _v1$2;
					}
				case 'Leaf':
								...
								return _List_fromArray(
									[
										...
										A2(
											...
											vars) + (':' + ($author$project$Main$showType(ty) + (' ∈ ' + A2($author$project$Main$showContext, c, vars)))))
									]);
							case 'Node':
								var children = _v2.a;
								return A2(
									...
									A2(
										...
										function (x) {
											return A2(
												...
												_List_fromArray(
													[
														A2($author$project$Main$showTree, x, vars)
													]));
										},
										children));
							case 'TypeErr':
								...
								if (_v3.$ === 'Node') {
									...
									return _List_fromArray(
										[
											...
											($elm$core$List$length(children) * 2) - 1)
										]);
								} else {
									return _List_Nil;
								}
...
var $author$project$Main$view = function (model) {
	var typeVarsVisible = model.showTreeUI && (!_Utils_eq(model.typeVars, _List_Nil));
	var stepCount = $elm$core$String$fromInt(model.stepIndex) + ('/' + $elm$core$String$fromInt(
		$elm$core$List$length(model.steps)));
	var low = model.stepIndex === 1;
	var high = _Utils_eq(
		model.stepIndex,
		$elm$core$List$length(model.steps));
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('program_input')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick($author$project$Main$SubmitInput)
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('↲')
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('parse_note')
							]),
						_List_fromArray(
							[
								(model.iNote === '') ? A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('no_err')
									]),
								_List_Nil) : A2(
								$elm$html$Html$div,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('err')
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$text(model.iNote)
											]))
									]))
							])),
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										model.showTreeUI ? A2($author$project$Main$showTree, model.tree, model.vars) : A2($elm$html$Html$div, _List_Nil, _List_Nil)
									]))
							])),
						A2(
						$elm$html$Html$div,
									...
									[
										...
										_List_fromArray(
											[
												...
												$elm$html$Html$Attributes$disabled(dui || low)
											]),
										_List_fromArray(
											[
												$elm$html$Html$text('<<')
										...
										_List_fromArray(
											[
												$elm$html$Html$Events$onClick($author$project$Main$StepBack),
												$elm$html$Html$Attributes$disabled(dui || low)
											]),
										_List_fromArray(
											[
										...
										_List_fromArray(
											[
												dui ? $elm$html$Html$text('-/-') : $elm$html$Html$text(stepCount)
											])),
										A2(
										$elm$html$Html$button,
										_List_fromArray(
											[
												$elm$html$Html$Events$onClick($author$project$Main$StepForward),
												$elm$html$Html$Attributes$disabled(dui || high)
											]),
										_List_fromArray(
											[
												$elm$html$Html$text('>')
										...
										_List_fromArray(
											[
												$elm$html$Html$Events$onClick($author$project$Main$ExpandWhole),
												$elm$html$Html$Attributes$disabled(dui || high)
											]),
										_List_fromArray(
											[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(model.tNote)
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
